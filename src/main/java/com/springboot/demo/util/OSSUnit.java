 ...
 * @description: java操作阿里云的对象存储OSS
 * @author: lixing
 * @create: 2020-10-28 10:56
 * 原文章:https://blog.csdn.net/y19910825/article/details/56511075
 **/
public class OSSUnit {
    ...
    //init static datas
    static {
        ResourceBundle bundle = PropertyResourceBundle.getBundle("application.properties");
